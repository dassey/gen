/*
 * polygon-clipping v0.15.7 (MIT) — https://github.com/mfogel/polygon-clipping
 * Bundled UMD build (includes splaytree v3.1.2, MIT), wrapped as an ES module.
 * The published .esm.js build leaves `splaytree` as a bare import, which no
 * browser can resolve without a bundler; this wrapper keeps the app buildless.
 */
